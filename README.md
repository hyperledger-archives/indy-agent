...
|IndyCat|Government of British Columbia|cloud for institutions (besides agent, includes framework for general SSI features in agents)|not yet published on the web, but X% passed in Feb 2019|[github.com/ bcgov/ indy-catalyst/](https://github.com/bcgov/indy-catalyst/tree/master/agent)|
