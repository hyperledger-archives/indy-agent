...
(function() {
    ...
    function pack_message(message, to_keys, from_keys = null) {
    ...
    function unpack_message(enc_message, to_keys) {
    ...
    function test(alice) {
        ...
        packed_msg = indy.pack_message("testing", [bob.publicKey], alice);
        console.log(packed_msg);
        console.log(indy.unpack_message(packed_msg, bob));
    }

    indy.test = test;
    indy.pack_message = pack_message;
    indy.unpack_message = unpack_message;
    indy.b64url = b64url;
}).call(this);
