...
htmlhelp_basename = 'IndyAgentdoc'
...
latex_documents = [
    (master_doc, 'IndyAgent.tex', 'Indy Agent Documentation',
...
man_pages = [
    (master_doc, 'indyagent', 'Indy Agent Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IndyAgent', 'Indy Agent Documentation',
     author, 'IndyAgent', 'One line description of project.',
     'Miscellaneous'),
]
